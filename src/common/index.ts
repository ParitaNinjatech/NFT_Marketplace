import {
    ...
    ArrowUpOnSquareIcon, LockOpenIcon , EllipsisHorizontalIcon
...
export {
    ...
    AdjustmentsHorizontalIcon, ChevronUpDownIcon, ArrowUpOnSquareIcon, LockOpenIcon , EllipsisHorizontalIcon
