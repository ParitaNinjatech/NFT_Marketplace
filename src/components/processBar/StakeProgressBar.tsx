    ...
    return (
        ...
        >
            ...
            >
                ...
                <h2 className="text-2xl font-semibold  outfit-bold">Approve Stake NFT</h2>
                <div className="flex items-center mt-4">
                    <div className="relative">
                        {loading && (
                            <div className="absolute inset-0 flex justify-center items-center  opacity-150">
                                <span className="StakeProgressBar"></span>
                            </div>
                        )}
                        <img
                            src={Cea1}
                    ...
                    <div className="ml-auto text-right">
                        <p className="text-lg font-semibold  outfit-bold">30 days</p>
                        <p className="text-md text-gray-500 outfit-light">2.5% rewardRate</p>
                    </div>
                </div>
...
export default StakeProgressBar;
