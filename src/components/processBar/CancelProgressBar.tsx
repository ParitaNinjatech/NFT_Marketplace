...
function CancelProgressBar({ loading, isOpen, onClose, onCloseLoading }: ModalProps) {
    useEffect(() => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <h2 className="text-2xl font-semibold  outfit-bold">Cancel listing</h2>
                <div className="flex items-center mt-4">
                    <div className="relative">
                        {loading && (
                            <div className="absolute inset-0 flex justify-center items-center  opacity-150">
                                <span className="CancelProgressBar"></span>
                            </div>
                        )}
                        <img
                            src={Cea1}
...
export default CancelProgressBar
