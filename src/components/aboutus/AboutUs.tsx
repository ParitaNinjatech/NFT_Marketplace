    ...
    return (
        <div className='m-4'>
                ...
                <div className="flex flex-col items-center justify-center text-center mt-10 px-4 mb-10">
                    <h1 className="text-2xl md:text-5xl font-bold outfit-bold text-gray-900">
                        About Us
                    </h1>
                    <p className="mt-4 text-gray-600 outfit-light max-w-2xl">
                    Welcome to our NFT Marketplace – a platform for creators, collectors, and enthusiasts to mint, trade, and explore NFTs. We bridge digital art and blockchain technology, offering a seamless space to engage with the NFT ecosystem. Discover our vision and what sets us apart.</p>
                </div>
            </div>
