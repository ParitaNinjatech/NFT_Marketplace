...
import { AdjustmentsHorizontalIcon, ChevronUpDownIcon, HeartIcon, ShoppingCartIcon } from "../../common/index";
...
function BuyNFTSectionOne() {
    ...
    const [isBuyingProcess, setIsBuyingProcess] = useState<boolean>(false);
