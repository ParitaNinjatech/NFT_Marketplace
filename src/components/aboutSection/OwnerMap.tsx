...
function OwnerMap() {
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <h1 className='text-3xl font-bold text-gray-800 mb-10'>Contact Our NFT Marketplace Team</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4  ">
                {[
                    ...
                    <div
                        ...
                        <h3 className="text-xl font-bold text-gray-800 text-center">{info.title}</h3>
                        <p className="text-gray-600 mt-2 text-center">{info.description}</p>
                        <p className="text-blue-600 mt-2 font-semibold text-center">{info.data}</p>
                    </div>
                ))}
            </div>
        </div>
